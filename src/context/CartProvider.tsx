...
export type CartContextProps = {
  modalOpen: boolean;
  addingToCart: string | undefined;
  cartLoading: boolean;
  updatingItem: string | undefined;

  cart: Cart | undefined;
  currency: { code: string };

  add: (productId: string, variantId: number, quantity?: number) => Promise<void>;
...
export const CartContextProvider: React.FC = ({ children }) => {
  ...
  const add = async (productId: string, variantId: number, quantity?: number) => {
